...
React.createElement("div",{style:{maxWidth:1100,margin:"0 auto",padding:"0 0.75rem",display:"flex",alignItems:"center",gap:8}},
  // Logo
  React.createElement("div",{style:{display:"flex",alignItems:"center",gap:8,padding:"10px 0",flexShrink:0}},
    React.createElement("div",{style:{width:34,height:34,borderRadius:8,background:`linear-gradient(135deg,${GOLD},#E8C55A)`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,flexShrink:0}},"🕌"),
    React.createElement("div",{style:{display:"none",whiteSpace:"nowrap"}})
  ),
  // Nav scrollbar
  React.createElement("nav",{style:{display:"flex",gap:0,overflowX:"auto",flex:1,WebkitOverflowScrolling:"touch",scrollbarWidth:"none",msOverflowStyle:"none"}},
    NAV.map(n=>React.createElement("button",{key:n.id,onClick:()=>setPage(n.id),style:{padding:"10px 12px",border:"none",background:page===n.id?`${GOLD}18`:"transparent",color:page===n.id?GOLD:"#888",fontSize:13,fontWeight:page===n.id?700:400,borderRadius:8,cursor:"pointer",fontFamily:"inherit",borderBottom:page===n.id?`2px solid ${GOLD}`:"2px solid transparent",whiteSpace:"nowrap",flexShrink:0}},n.label))
  ),
  // Syncing + Abmelden
  ...
  React.createElement("button",{onClick:()=>supabase.auth.signOut(),title:"Abmelden",style:{flexShrink:0,padding:"6px 10px",borderRadius:20,border:`1px solid ${GOLD}44`,background:"white",color:"#AAA",fontSize:11,cursor:"pointer",fontFamily:"inherit",whiteSpace:"nowrap"}},"↩")
)
    ),
